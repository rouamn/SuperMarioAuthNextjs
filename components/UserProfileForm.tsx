...
import 'react-phone-input-2/lib/style.css'; // Import the CSS for the PhoneInput
...
const UserProfileForm: React.FC<UserProfileFormProps> = ({ user }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const newErrors = await validate(firstName, lastName, birthDate, phone, address);
        setErrors(newErrors);
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col">
              ...
              <div className="flex">
                  <PhoneInput
                      country={'tn'} // Set the default country if needed
                      value={phone}
                      onChange={(phone) => setPhone(phone)}
                      inputClass="border rounded-lg p-2 mt-1 flex-1" // Using inputClass instead of inputStyle
                  />
              </div>
